"""
Simple test script for incident orchestrator (avoiding import conflicts).

Run from project root with: python3 test_orchestrator_simple.py
"""
...
async def test_orchestrator():
    ...
    if response['alerts']:
        ...
        print("  → No alerts generated (severity too low)")
    print()
